        ...
        <div className='flex  justify-center bg-slate-600 items-center '>
            ...
            <div className="card w-96 bg-white  shadow-2xl">
                <div className="card-body">
                    <div className="divider text-3xl font-bold">Sign Up</div>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <p><small>Already have a Account? <Link to="/login" className='text-secondary '>Create New Account</Link></small></p>
                    ...
                    <div className='grid grid-flow-col gap-4 mx-auto justify-center '>
